...
(require
 ...
 (only-in tagged/racket/draw Font-Weight Font-Style Font% make-font current-ps-setup pdf-dc% the-color-database)
 (only-in tagged/racket/class inherit define/override send* class new super-new send define/public object% this)
