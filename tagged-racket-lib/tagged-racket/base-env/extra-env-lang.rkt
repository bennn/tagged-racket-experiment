...
(define-syntax (-#%module-begin stx)
  (syntax-parse stx
    [(mb e ...)
     #'(#%plain-module-begin
        (require (for-syntax tagged-racket/env/env-req))
        e ...
         ...
         (begin-for-syntax
          (module* #%type-decl #f
                   (#%plain-module-begin ;; avoid top-level printing and config
                    ...
                    (require tagged-racket/types/numeric-tower tagged-racket/env/type-name-env
                             tagged-racket/env/global-env tagged-racket/env/type-alias-env
                             tagged-racket/types/struct-table tagged-racket/types/abbrev
                             tagged-racket/typecheck/tc-structs
                             (only-in tagged-racket/rep/type-rep make-Name make-Opaque)
