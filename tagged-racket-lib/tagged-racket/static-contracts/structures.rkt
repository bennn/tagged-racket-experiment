...
(require "../utils/utils.rkt"
         ...
         "kinds.rkt" "constraints.rkt" "logger.rkt")
...
(define-generics sc
  ...
  ;; Takes a static contract and returns a weaker static contact that implements an O(1) tag check.
  ;; The function argument should be used for sub parts of the static contract.
  [sc->tag-sc sc f]
...
;; In each value and the body, each name is bound to the corresponding value contract.
