...
(lazy-require
  [tagged-racket/base-env/base-env ((init init-base-env))]
  [tagged-racket/base-env/base-env-numeric ((init init-base-env-numeric))]
  [tagged-racket/base-env/base-structs (initialize-structs)]
  [tagged-racket/base-env/base-env-indexing (initialize-indexing)]
  [tagged-racket/base-env/base-special-env (initialize-special)]
  [(submod tagged-racket/base-env/base-types initialize) (initialize-type-names)])
