...
(lazy-require [tagged-racket/defender/defender (defend-top)])
(lazy-require [tagged-racket/optimizer/optimizer (optimize-top)])
(lazy-require [tagged-racket/typecheck/tc-toplevel (tc-module)])
(lazy-require [tagged-racket/typecheck/toplevel-trampoline (tc-toplevel-start)])
